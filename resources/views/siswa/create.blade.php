...
<head>
    ...
    <title>Tambah Siswa - SIPRES | Sistem Informasi Prestasi Siswa</title>
...
<div class="sidebar" id="sidebar">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <div class="file-help">Password default menggunakan NIS</div>
                            </div>
                            ...
                            <div class="form-group full-width">
                                ...
                                <div class="upload-container">
                                    ...
                                    <div class="file-input-wrapper">
                                        ...
                                        <div class="file-help">Format: JPG, PNG. Maksimal 2MB</div>
                                        @error('foto')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('mata_pelajaran_favorit') }}"
    ...
    <script>
        ...
        // Preview foto untuk modal profile
