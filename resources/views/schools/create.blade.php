...
<head>
    ...
    <title>Tambah Sekolah - SIPRES | Sistem Informasi Prestasi Siswa</title>
    ...
    <div class="sidebar-footer">
        ...
        <div class="main-content" id="mainContent">
            ...
            <div class="alert alert-danger">
                <i class="fas fa-exclamation-circle"></i> Terdapat kesalahan pada input data. Silakan periksa kembali.
            </div>
            @endif
                    ...
                    <form action="{{ route('schools.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            <label for="name" class="form-label">
                                ...
                                Nama Sekolah <span style="color: var(--danger);">*</span>
                            </label>
                            <input type="text" 
                                   id="name" 
                                   name="name" 
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                <label for="npsn" class="form-label">
                                    ...
                                    NPSN <span style="color: var(--danger);">*</span>
                                </label>
                                <input type="text" 
                                       id="npsn" 
                                       name="npsn" 
                            ...
                            <div class="form-group">
                                <label for="school_level" class="form-label">
                                    <i class="fas fa-graduation-cap"></i>
                                    Jenjang Sekolah
                                </label>
                                <select name="school_level" id="school_level" class="form-control @error('school_level') is-invalid @enderror">
                                    ...
                                    <option value="sma" {{ old('school_level') == 'sma' ? 'selected' : '' }}>SMA / MA</option>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                <label for="phone" class="form-label">
                                    ...
                                    Telepon <span style="color: var(--danger);">*</span>
                                </label>
                                <input type="text" 
                                       id="phone" 
                                       name="phone" 
                        ...
                        <div class="form-group">
                            <label for="nip_kepala_sekolah" class="form-label">
                            ...
                            <input type="text" 
                                   ...
                                   placeholder="196512311990011001">
