...
<head>
    ...
    <title>Tambah Minat & Bakat - SIPRES | Sistem Informasi Prestasi Siswa</title>
    ...
    <style>
        * {
        ...
        .preview-badge.bahasa {
            background: #FFF4E5;
            color: #B76E00;
        }

        .preview-badge.teknologi {
            background: #FFF4E5;
            color: #F57C00;
        }

        .preview-badge.lainnya {
            background: #F1F4F9;
            color: var(--secondary);
        }
...
<div class="sidebar" id="sidebar">
    ...
    <div class="sidebar-footer">
        ...
        <div class="main-content" id="mainContent">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('minat-bakat.store') }}" method="POST" id="minatForm">
                        @csrf
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                <label for="nama_minat" class="form-label">
                                    Nama Minat/Bakat <span class="required">*</span>
                                </label>
                                <input type="text" 
                                       id="nama_minat" 
                                       name="nama_minat" 
                                       value="{{ old('nama_minat') }}" 
                                       class="form-control @error('nama_minat') is-invalid @enderror" 
                                       placeholder="Contoh: Sepak Bola, Melukis, Matematika"
                                       required>
                                @error('nama_minat')
                        ...
                        <!-- Live Preview -->
                        <div class="category-preview" id="previewContainer" style="display: none;">
                            <div class="preview-badge" id="previewBadge">
                                <i class="fas fa-tag"></i>
                                <span id="badgeText">Olahraga</span>
                            </div>
                            <div class="preview-text" id="previewText">
                                <i class="fas fa-info-circle"></i> 
                                Minat/bakat ini akan masuk ke kategori <span id="categoryName">Olahraga</span>
                            </div>
                        </div>
                        ...
                        <div class="info-box" style="margin-top: 20px;">
                            ...
                            <span>Minat & bakat yang ditambahkan akan tersedia untuk semua siswa di sekolah ini.</span>
                        </div>
                        ...
                        <div class="form-actions">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Simpan Data Minat
                            </button>
                        </div>
                    </form>
                </div>
    ...
    <script>
        ...
        function updatePreview() {
            ...
            if (selectedValue) {
                // Update class badge
                previewBadge.className = 'preview-badge ' + selectedValue;
                
                // Update icon based on category
                const icon = previewBadge.querySelector('i');
                if (selectedValue === 'olahraga') {
                    icon.className = 'fas fa-futbol';
                } else if (selectedValue === 'seni') {
                    icon.className = 'fas fa-palette';
                } else if (selectedValue === 'sains') {
                    icon.className = 'fas fa-flask';
                } else if (selectedValue === 'bahasa') {
                    icon.className = 'fas fa-language';
                } else if (selectedValue === 'teknologi') {
                ...
                // Update text
                badgeText.textContent = selectedText;
        ...
        // Show preview if there's old value
