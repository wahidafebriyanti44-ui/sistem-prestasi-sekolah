...
<head>
    ...
    <title>Edit Ekstrakurikuler - SIPRES | Sistem Informasi Prestasi Siswa</title>
    ...
    <div class="sidebar-footer">
        ...
        <div class="main-content" id="mainContent">
            ...
            <div class="action-bar">
                <h2>Form Edit Ekstrakurikuler</h2>
                <div style="display: flex; gap: 10px;">
                    <a href="{{ route('eskul.show', $eskul) }}" class="btn btn-secondary">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('eskul.update', $eskul) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-grid">
                            ...
                            <div class="full-width" style="margin-top: 10px;">
                                <div class="info-box">
                                    ...
                                    Perubahan data ekstrakurikuler akan mempengaruhi semua data anggota yang terkait.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-actions">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Update Data Eskul
                            </button>
                        </div>
                    </form>
                </div>
