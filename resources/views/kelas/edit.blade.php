...
<head>
    ...
    <title>Edit Kelas - SIPRES | Sistem Informasi Prestasi Siswa</title>
        ...
        <div class="main-content" id="mainContent">
            ...
            <div class="card">
                <div class="card-header">
                    <h2><i class="fas fa-edit"></i> Form Edit Kelas</h2>
                </div>
                <div class="card-body">
                    <form action="{{ route('kelas.update', $kelas->id) }}" method="POST">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" id="nama_kelas" name="nama_kelas" value="{{ old('nama_kelas', $kelas->nama_kelas) }}" class="form-control @error('nama_kelas') is-invalid @enderror" placeholder="Contoh: X IPA 1, XII RPL 2" required>
                            ...
                            <div class="form-group">
                                ...
                                <select id="tingkat" name="tingkat" class="form-select @error('tingkat') is-invalid @enderror" required>
                                    ...
                                    <option value="10" {{ (old('tingkat', $kelas->tingkat) == '10') ? 'selected' : '' }}>Kelas 10 (X)</option>
                                    <option value="11" {{ (old('tingkat', $kelas->tingkat) == '11') ? 'selected' : '' }}>Kelas 11 (XI)</option>
                                    <option value="12" {{ (old('tingkat', $kelas->tingkat) == '12') ? 'selected' : '' }}>Kelas 12 (XII)</option>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-text">Kosongkan jika tidak ingin mengubah wali kelas</div>
                            </div>
                        </div>
                        ...
                        <div class="form-actions">
                            ...
                            <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> Update Data Kelas</button>
                        </div>
                    </form>
                </div>
            </div>
