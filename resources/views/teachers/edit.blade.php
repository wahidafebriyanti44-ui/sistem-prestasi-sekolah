...
<head>
    ...
    <title>Edit Guru - SIPRES | Sistem Informasi Prestasi Siswa</title>
                            ...
                            <div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="current-photo">
                                        <img src="{{ $teacher->photo_url }}" alt="{{ $teacher->name }}" class="current-photo-img">
                                        <div class="current-photo-info">
                                            <p><i class="fas fa-image"></i> Foto saat ini</p>
                                            <small>Kosongkan file jika tidak ingin mengubah foto.</small>
                                        </div>
                                    </div>
                                    @endif
                                ...
                                <div class="switch-group">
                                    <label class="switch-label">
                                        <input type="checkbox" 
                                               name="is_homeroom" 
                                               value="1"
                                               {{ old('is_homeroom', $teacher->is_homeroom) ? 'checked' : '' }}>
