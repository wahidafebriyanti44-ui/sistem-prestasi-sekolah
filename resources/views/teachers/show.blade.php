...
<head>
    ...
    <title>Detail Guru - SIPRES | Sistem Informasi Prestasi Siswa</title>
                    ...
                    <div class="profile-info">
                        ...
                        <div class="profile-details">
                            <div class="info-grid">
                                ...
                                <div class="info-item">
                                    <div class="info-label">
                                        <i class="fas fa-calendar-alt"></i> Tempat, Tanggal Lahir
                                    </div>
                                    <div class="info-value">
                                        @if($teacher->birth_place && $teacher->birth_date)
                                            {{ $teacher->birth_place }}, {{ $teacher->birth_date->format('d F Y') }}
                                        @else
                                            -
                                        @endif
                                    </div>
                                ...
                                <div class="info-item">
                                    <div class="info-label">
                                        <i class="fas fa-school"></i> Wali Kelas
                                    </div>
                                    <div class="info-value">
                                        @if($teacher->is_homeroom && $teacher->homeroom)
                                            <span class="badge badge-info">
                                                <i class="fas fa-school"></i> {{ $teacher->homeroom->nama_kelas ?? '-' }}
                                            </span>
                                        @elseif($teacher->is_homeroom)
                                            <span class="badge badge-warning">Belum ditugaskan ke kelas</span>
                                        @else
                                            <span class="badge badge-secondary" style="background: #F1F4F9; color: var(--secondary);">Bukan Wali Kelas</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="meta-info">
                                <div class="meta-item">
                                    ...
                                    <span>Dibuat: {{ $teacher->created_at->format('d F Y H:i') }}</span>
                                </div>
                                <div class="meta-item">
                                    <i class="fas fa-calendar-edit"></i>
                                    <span>Diupdate: {{ $teacher->updated_at->format('d F Y H:i') }}</span>
                                </div>
                            </div>
                            ...
                            <div class="action-buttons">
                                ...
                                <form action="{{ route('teachers.destroy', $teacher) }}" method="POST" style="display: inline;" onsubmit="return confirm('Yakin ingin menghapus data guru {{ $teacher->name }}? Akun user juga akan ikut terhapus.')">
                                    @csrf
                                    @method('DELETE')
