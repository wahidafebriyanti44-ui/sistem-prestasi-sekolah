...
<head>
    ...
    <style>
        /* STYLE SAMA SEPERTI SEBELUMNYA - COPY dari file Anda yang sudah ada */
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="container">
        ...
        <div class="main-content" id="mainContent">
            ...
            <!-- Action Bar - PERUBAHAN: Hanya Admin Sekolah yang bisa tambah prestasi -->
            ...
            <div class="filter-section">
                <form method="GET" action="{{ route('prestasi.index') }}" class="filter-form">
                    @if(Auth::user()->role == 'super_admin')
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="action-buttons">
                                                ...
                                                <!-- PERUBAHAN: HANYA ADMIN SEKOLAH YANG BISA EDIT -->
                                                @if(Auth::user()->role == 'admin_sekolah')
                                                ...
                                                <!-- PERUBAHAN: HANYA ADMIN SEKOLAH YANG BISA HAPUS -->
                                                @if(Auth::user()->role == 'admin_sekolah')
                                                ...
                                                <!-- PERUBAHAN: HANYA ADMIN SEKOLAH YANG BISA VERIFIKASI -->
